...
class UpdateStudentPage extends StatefulWidget {
  //id from which it is coming for updating the data
  final String id;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Form(
          ...
          //Getting specific data by ID (fetching data)
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        initialValue: name,
                        autofocus: false,
                        // the date user enters will come inside this OnChanged method
                        ...
                        // Controller is not Used here incase of updating details
                    ...
                    // Another Conatiner for EMail input
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 10.0),
                      child: TextFormField(
                        initialValue: email,
